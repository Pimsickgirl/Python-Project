...
def display_results():
    entered_password = simpledialog.askstring("Password", "กรุณาใส่รหัสผ่าน:", show='*')
    if entered_password == password:
        ...
        messagebox.showerror("Invalid Password", "รหัสผ่านไม่ถูกต้อง")
...
def main():
    ...
    # ทำการเพิ่มคำสั่ง bind ให้กับการปิดหน้าต่าง
    tps.protocol("WM_DELETE_WINDOW", on_closing)
    tps.mainloop()
